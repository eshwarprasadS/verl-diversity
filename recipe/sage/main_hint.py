...
"""
Hydra entry point for SAGE hint training.
"""
...
from recipe.sage.hint_trainer import RayHintTrainer


@hydra.main(config_path="config", config_name="hint_trainer", version_base=None)
def main(config):
    """Main entry point for SAGE hint training with Hydra configuration."""
    run_ppo(config)
...
class TaskRunner(BaseTaskRunner):
    ...
    def run(self, config):
        """Execute the main PPO training workflow with SAGE hint trainer."""
...
def run_ppo(config, task_runner_class=None) -> None:
    """Initialize Ray cluster and run SAGE hint training."""
