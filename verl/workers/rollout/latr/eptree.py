# LATR EPTree (entropy-guided chain search) for TreeRL-style rollouts.
# Ported from https://github.com/starreeze/latr/blob/main/model/eptree.py
# Only the EPTree class and its dependencies are included.
# The main() function is removed as it was only for standalone testing.
...
class TreeNode:
    def __init__(
        ...
        # Step 1: compute parent (prefix) info
        ...
        # Step 3: generate strings from (possibly truncated) lists
