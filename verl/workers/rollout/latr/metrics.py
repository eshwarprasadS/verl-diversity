# LATR metrics: standalone numba-JIT functions for sequence comparison.
# Ported verbatim from https://github.com/starreeze/latr/blob/main/model/metrics.py
# No verl dependencies.
