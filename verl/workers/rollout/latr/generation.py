# LATR key-token tree search generation logic.
# Ported from https://github.com/starreeze/latr/blob/main/model/generation.py
...
from verl.workers.rollout.latr.diverge import DivJudge
from verl.workers.rollout.latr.sample_filter import (
    KeyTokenFilterList,
    ModelFilter,
    create_key_token_filter,
    create_sequence_filter,
)
from verl.workers.rollout.latr.kt_utils import (
    BranchInfo,
...
from verl.workers.rollout.latr._utils import get_repeat_interleave, init_dataclass_from_dict, update_additive_stats
...
def _sample_new_sequence_with_rollout(
    ...
    probs_processed: torch.Tensor,
    current_ids: torch.Tensor,
    attention_mask: torch.Tensor,
    cache: MixedCache,
    complete_mask: torch.Tensor,
    ...
    topk_probs, topk_ids = probs_raw.topk(max_n_branch_per_token, dim=-1)
...
def generate(
    ...
    **kwargs,
    ...
    for step in wrapped_range:
        ...
        # Synchronize KT early stop across ranks
