# LATR divergence judgement model for key-token filtering.
# Ported from https://github.com/starreeze/latr/blob/main/model/diverge.py
...
class DivJudge(nn.Module):
    ...
    def forward(self, input_ids: Tensor, attention_mask: Tensor) -> Tensor:
        ...
        Args:
            input_ids: Tensor of shape [batch_size * 2, seq_len]
            attention_mask: Tensor of shape [batch_size * 2, seq_len]
